...
My project was inspired by Helena Sarin's process and her application of CycleGAN in her own practice. While reading through the article assigned as a class reading, I remember thinking that I want to experiment just like that since I am an artist myself, a lettering artist to be more specific. When I first started working on my final project, I didn't know where to start as I did not have nearly enough data to train a GAN and I knew that I wanted to use my own lettering work as an input. My first step in this project was to have enough data to be able to train any model. Therefore, I started with a StyleGAN2 ADA by Derrick Schultz since did not require as much data to train. I loaded around 15 sketches and prayed the model would work. It didn't. So again, I loaded 20, 27, 30, and as I was getting tired sketching new images, it finally worked with a dataset of 33 images.

The aim of my project is purely experimental, as I use two different GAN models (StyleGAN2 and CycleGAN) to generate images. One thing I decided from the moment I started working on this project however, is that I wanted to use my own lettering work as a dataset. Unfortunately, I didn't have nearly enough data to train any model, since as a versatile artist, I don't follow a specific style or pattern in my work. I just didn't have enough data within the same style.

Therefore, I concluded that the first step of this project would be having enough data and so I started sketching out my dataset. Soon, I realized that it was too exhausting to do that, so I decided to load my small dataset into a StyleGAN2 ADA model that didn't require a large dataset to train. The aim here was to train the model so that it can generate the new dataset for me. 
---
## Project Structure:
